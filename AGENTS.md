...
| **Storybook UI dev** (stories, component docs)                   | `storybook-mcp` (`get-storybook-story-instructions`, `preview-stories`, `get-documentation`, `get-documentation-for-story`, `list-all-documentation`, `run-story-tests`) |
